...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', default='test', choices=['pmdc'])
    ...
    parser.add_argument('--test_data_dir', type=str, default='test', help='')
    ...
    parser.add_argument('--test_model', type=str, default='CRNN', choices=["CRNN"])
    ...
    parser.add_argument('--tpg', type=str, default="CRNN", choices=['CRNN'])
